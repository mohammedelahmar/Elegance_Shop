              ...
              <Card.Body className="p-5 text-center">
                ...
                <div className="d-grid gap-3">
                  <Link to={`/order/${orderId}`} className="text-decoration-none">
                    <Button variant="primary" size="lg" className="w-100 primary-glow-btn">
                      <FaReceipt className="me-2" /> View Order Details
                    </Button>
                  </Link>
                  
                  <Link to="/products" className="text-decoration-none">
                    <Button variant="outline-primary" size="lg" className="w-100 ghost-btn">
